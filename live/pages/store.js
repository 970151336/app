...
(function () {
  ...
  function slim(d) {
    return {
      id: d.id, name: d.name, logo: d.logo, code: d.code, countryName: d.countryName,
      langCN: d.langCN, group: d.group, category: d.category, theme: d.theme, url: d.url
    };
  }
  ...
  const AppStore = {
    ...
    clearFavs() { write(FAV, []); emit('fav', null); },
    /* 订阅：跨 iframe 实时同步 */
    subscribe(cb) {
